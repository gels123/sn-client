...
namespace cfg
{
public sealed partial class TestFirst : Luban.BeanBase
{
    public TestFirst(JSONNode _buf) 
    {
    ...
    public static TestFirst DeserializeTestFirst(JSONNode _buf)
    {
        return new TestFirst(_buf);
    }
    ...
    public const int __ID__ = 800442654;
